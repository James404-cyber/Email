...
<h2 align="center"> FB GMAIL CRACKING TOOL </h2>

<p align="center">
      LATEST FB GMAIL CLONING WITHOUT LOGIN
</p>
...
$ pip2 install bs4
$ pkg install git
$ git clone https://github.com/James404-cyber/Email.git
$ cd Email
$ python2 python2 All.py
```

# Single Command 

```
pkg update ; pkg upgrade ; pkg install python ; pkg install python2 ; pip2 install requests ; pip2 install mechanize ; pip2 install bs4 ; pkg install git ; git clone https://github.com/James404-cyber/Email.git ; cd Email ; python2 python2 All.py
```
